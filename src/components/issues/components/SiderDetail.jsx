...
const items = [
  getItem("Kanban Board", "1", <InsertRowBelowOutlined />),
  getItem("Releases", "2", <RocketOutlined />),
  getItem("Reports", "3", <LineChartOutlined />),
  getItem("Issues", "5", <SnippetsOutlined />),
  getItem("Components", "6", <BuildOutlined />),
  getItem("Management", "7", <ContactsOutlined />),
  getItem("Timesheets", "8", <FieldTimeOutlined />),
  getItem("Income", "9", <AreaChartOutlined />),
];

export default function SiderDetail({ issue }) {
  ...
  return (
    <>
      ...
      >
        <div className="d-flex align-center" style={{ padding: "15px" }}>
          <svg
            id="Default"
