...
export default function ManageUser() {
  ...
  const handleSubmitCreate = async () => {
    ...
    const data = {
      ...
      birthDay: inputData.inputBirthDay.format("YYYY-MM-DDTHH:mm:ss"),
    };
  ...
  const handleUpdateGuest = async () => {
    ...
    const data = {
      ...
      birthDay: editData.editBirthDay.format("YYYY-MM-DDTHH:mm:ss"),
                  ...
                  <Col>
                    <Row>
                      ...
                      <DatePicker
                        ...
                        onChange={(date) =>
                          handleEditInputChangeDate(date, "editBirthDay")
                        }
                      />
                      {errors.editBirthDay && (
                        <div
                  ...
                  <Col>
                    <Row>
                      ...
                      <DatePicker
                        ...
                        // value={inputData.inputBirthDay ? dayjs(inputData.inputBirthDay, dayFormat) : null}
                        onChange={(date) =>
                          handleAddInputChangeDate(date, "inputBirthDay")
                        }
                        name="inputBirthDay"
                      />
